...
function startGame() {
	if (gameStarted == false) {
        ...
        document.getElementById('leaderboardButton').disabled = true;
...
function fireworks1(){
if(imageChange1.src.match("../Images/NoFirework.png")){
        imageChange1.src = "../Images/ColorsFireworks.gif";
    }
}
function fireworks2(){
if(imageChange2.src.match("../Images/NoFirework.png")){
        imageChange2.src = "../Images/ColorsFireworks.gif";
    }
}
function fireworksOff1(){
if(imageChange1.src.match("../Images/ColorsFireworks.gif")){
        imageChange1.src = "../Images/NoFirework.png";
    }
}
function fireworksOff2(){
if(imageChange2.src.match("../Images/ColorsFireworks.gif")){
        imageChange2.src = "../Images/NoFirework.png";
    }
}
